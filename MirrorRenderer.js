...
const MirrorRenderer = function (renderer, camera, scene, options) {
...
MirrorRenderer.prototype = Object.create(THREE.Object3D.prototype);

MirrorRenderer.prototype.renderWithMirror = function (otherMirror) {
...
MirrorRenderer.prototype.updateTextureMatrix = function () {
...
MirrorRenderer.prototype.render = function (isTempTexture) {
